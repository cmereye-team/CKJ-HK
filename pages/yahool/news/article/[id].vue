  ...
  <div>
    ...
    <div class="pageIn whitebgColor articlePage">
      ...
      <div class="tabNav noTitle pageCon">
        ...
        <nuxt-link :to="'/yahool/news/coverage'">
        ...
        <div class="content-bdetail">
          <div class="content-bdetail-in">
            ...
            <div class="news" style="display: none" v-if="pageType === '1'">
              <h4>閱讀更多媒體報導︰</h4>
              <nuxtLink
                :to="`/yahool/news/article/${associationItem.id}`"
                v-for="(
            ...
            <div class="btn" style="display: none">
              ...
              >
              <nuxt-link
                :to="pageType === '1' ? '/yahool/news/coverage' : '/yahool/news/information'"
                >返回所有文章目錄</nuxt-link
              >
              <el-button
    ...
    .context {
      ...
      .righeBox {
        ...
        a {
          ...
          cursor: pointer;
          &.copy {
            background: url(@/assets/yahool/images/icon_19.svg);
            background-size: 100% 100%;
          }
          &.facebook {
            background: url(@/assets/yahool/images/icon_20.svg);
            background-size: 100% 100%;
            margin-left: 14px;
          }
          &:hover {
