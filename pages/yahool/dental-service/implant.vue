...
<template>
  <div class="implant_yahoo">
    <YahooPageHeader :headerConfig="headerConfig" />
    <div class="dentistryServices">
      ...
      <div class="technology">
        ...
        <div class="technology-btn">
          <YahooPageAnimBtnTypeTwo str="取得免費口腔CT檢查" />
        </div>
      </div>
      ...
      <YahooServiceReason :reasonData="reasonData" />
      <div class="step">
        <div class="step-in">
          ...
          <div class="step-lists" v-if="windowWidth > 768">
            ...
            >
              <div class="step-lists-in-l">
                <div class="title">
                  <img src="@/assets/yahool/images/icon_13.png" alt="" />
                  {{ stepItem.title }}
                </div>
              ...
              <div class="step-lists-in-r">
                <img src="@/assets/yahool/images/icon_12.png" alt="" />
              </div>
            </div>
          </div>
            ...
            <div class="Plant_brand_series-content">
              ...
              <div class="Plant_brand_series-content-r">
                ...
                <div>
                  <span
                    v-for="(
                      tabspanitem, tabspanindex
                    ) in plant_brand_series_item.name"
                    :key="tabspanindex"
                  >
                    {{ tabspanitem }}
                  </span>
      ...
      <div class="doctorTeam" ref="doctorTeam">
        <YahooServiceSpecializedTeam :doctorData="doctorData" />
      </div>
      ...
      <YahooServiceCase v-if="windowWidth > 768" />
      ...
      <YahooServiceProblem :problemData="problemData" />
...
.dentistryServices {
  ...
  .implantCase {
    ...
    &-content {
      ...
      width: 100%;
      position: relative;
      cursor: url(@/assets/yahool/images/icon_17.svg) 54 54, auto;
      .implantCaseBoxSwiper {
        ...
        .implantCaseBox {
          ...
          &-t {
            ...
            overflow: hidden;
            transition: all 0.3s;
            cursor: url(@/assets/yahool/images/icon_18.svg) 54 54, auto;
            div {
              width: 100%;
            }
            img {
