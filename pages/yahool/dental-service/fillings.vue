...
const getUrl = (file) => {
  return new URL(`../../../images/${file}.svg`, import.meta.url).href
}
  ...
  <div>
    ...
    <div class="pageIn whitebgColor">
            ...
            <div class="step-lists-in">
              <div>
                ...
                <div class="lastBox-b">
                  ...
                  <YahooPageAnimBtnTypeTwo :str="'免費網上預約'" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="introduceJY">
        <YahooServiceIntroduceJY :introduceData="introduceJY" />
      </div>
      <div class="note">
      ...
      <div class="reason">
        ...
        <div class="reason-lists">
          ...
          >
            ...
            <div class="reason-lists-item-r">
              ...
              <div class="context">
                <img src="@/assets/yahool/images/icon_41.svg" alt="" />
                <span>特徵：{{ item.context }}</span>
                <span></span>
              </div>
              <div class="name" v-if="windowWidth > 768">
                <img src="@/assets/yahool/images/icon_40.svg" alt="" />
                <span>治療方法：</span>
              </div>
              <div class="list">
                <div
        ...
        <div class="reason-btn">
          ...
          <YahooPageAnimBtnTypeTwo :str="'立即WhatsApp查詢'" />
        </div>
      </div>
      ...
      <div class="care">
        ...
        <div class="care-btn">
          ...
          <YahooPageAnimBtnTypeTwo :str="'立即預約免費檢查'" />
        </div>
      </div>
      <div class="advantage">
        <div
