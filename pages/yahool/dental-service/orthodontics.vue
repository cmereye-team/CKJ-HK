...
import { toWhatsApp, whatsAppNum } from '~/assets/yahool/js/common'
...
<template>
  <div>
    ...
    <div class="orthodonticsPage">
      ...
      <div class="principle">
        ...
        <div v-if="windowWidth > 768">
          ...
          <div class="principle-btn">
            ...
            <YahooPageAnimBtnTypeTwo :str="'預約免費口腔檢查'" />
          </div>
        </div>
        ...
        <div class="step-in">
          ...
          <div class="step-lists" v-if="windowWidth > 768">
            ...
            <div class="step-lists-in">
              <div class="lastBox-t">
                <!-- <div><img src="@/assets/yahool/images/icon_13.png" alt="" /></div>
      ...
      <YahooServiceCard />
      <YahooNewAddress />
      <YahooContactForm-new class="contactForm" />
    </div>
    <YahooPageFooter />
    <YahooPageNavbar />
  </div>
