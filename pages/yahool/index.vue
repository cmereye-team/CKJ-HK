...
import doctorLists_cs from '~/assets/yahool/js/doctor'
import { toWhatsApp } from '~/assets/yahool/js/common'
  ...
  let a = [
    {
      idx: 0,
      id: 14,
      url: '/yahool/news/article/',
    },
    {
      idx: 1,
      id: 15,
      url: '/yahool/news/news-information/',
    },
    {
      idx: 2,
      id: 16,
      url: '/yahool/news/news-tooth-wiki/',
    },
  ]
...
const handlevideBoxBtn = () => {
  // router.push('')
  let _arr = ['/yahool/news/coverage', '/yahool/news/information', '/yahool/news/tooth-wiki']
...
<template>
  <div>
    <YahooPageNewHeader :headerConfig="headerConfigData" />
    <div class="indexPage">
      <!-- 最新消息 -->
      <!-- <LatestNews /> -->
      <!-- 牙科服務 -->
      <YahooServiceCard :isIndexShow="true" />
      <!-- 醫生團隊 -->
            ...
            >
              ...
              >
                ...
                <div class="index-doctorTeam-detail-r">
                  ...
                  <div class="detail-6">
                    <YahooPageAnimBtnTypeTwo str="線上咨詢" />
                  </div>
                </div>
              </div>
            </Swiper-slide>
      ...
      <div class="index-videoBox">
        ...
        <div class="index-videoBox-in" v-if="windowWidth > 767">
          ...
          >
            ...
            <div class="time" v-if="indexNewsCur === 2">
              ...
              >
                <div
                  ...
                  title="分享"
                >
                  <img src="@/assets/yahool/images/icon_47.svg" alt="" />
                </div>
                <div class="shareIcon-in" v-if="actShowShare === item.id">
                  <div
                    ...
                    title="Facebook 分享"
                  >
                    <img src="@/assets/yahool/images/icon_49.svg" alt="" /><span
                      >Facebook 分享</span
                    >
                  </div>
                  <div
                    ...
                    title="複製連結"
                  >
                    <img src="@/assets/yahool/images/icon_48.svg" alt="" /><span
                      >複製連結</span
                    >
                  </div>
                </div>
            ...
            <div class="btn">
              <YahooPageAnimBtnTypeTwo str="查看全文" :link="item.link" />
            </div>
          </nuxtLink>
        </div>
      ...
      <YahooServiceProblem :problem-data="problemData" />
      <!-- 聯絡我們 -->
      <YahooNewAddress />
