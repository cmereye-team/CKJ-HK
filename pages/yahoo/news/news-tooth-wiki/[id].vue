...
import { renderingDome } from '~/assets/yahoo/js/commonFun'
const { t } = useLang()
...
const toassociation = (_id) => {
  router.push(`/yahoo/news/news-tooth-wiki/${_id}`)
}
...
onMounted(() => {
  ...
  setTimeout(() => {
    if (route.path == '/yahoo/news/news-tooth-wiki/219') {
    ...
    if (route.path == '/yahoo/news/news-tooth-wiki/271') {
  ...
  <div>
    ...
    <div class="pageIn whitebgColor articlePage">
      ...
      <div class="tabNav noTitle pageCon">
        ...
        <nuxt-link :to="'/yahoo/news/tooth-wiki'">
