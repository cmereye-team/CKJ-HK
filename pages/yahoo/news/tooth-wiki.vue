        ...
        <div class="lists" v-if="!errorpage">
              ...
              <div class="lists-in-context">
                  ...
                  <div class="time">
                    ...
                    >
                      ...
                      <div class="shareIcon-in" v-if="actShowShare === item.id">
                        ...
                        >
                          <img
                            src="@/assets/yahoo/images/icon_49.svg"
                            alt=""
                        ...
                        >
                          <img
                            src="@/assets/yahoo/images/icon_48.svg"
                            alt=""
                          /><span>複製連結</span>
                        </div>
                      </div>
                ...
                <div class="btn">
                  <YahooPageAnimBtnTypeTwo
                    :link="`/yahoo/news/news-tooth-wiki/${item.id}`"
                    str="查看原文"
                  />
                </div>
              </div>
          ...
          <div class="lists-btn" v-if="strS === ''">
            <div @click="subNum" :class="{ btndisabled: actPageNum === 1 }">
              <span class="subNum">
                <img src="@/assets/yahoo/images/icon_25.svg" alt="" />
              </span>
            </div>
