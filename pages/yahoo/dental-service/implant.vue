          ...
          <div class="step-lists" v-if="windowWidth > 768">
            ...
            >
              <div class="step-lists-in-l">
                <div class="title">
                  <img src="@/assets/yahoo/images/icon_13.png" alt="" />
                  {{ stepItem.title }}
                </div>
              ...
              <div class="step-lists-in-r">
                <img src="@/assets/yahoo/images/icon_12.png" alt="" />
              </div>
            </div>
          </div>
...
.dentistryServices {
  ...
  .implantCase {
    ...
    &-content {
      ...
      width: 100%;
      position: relative;
      cursor: url(@/assets/yahoo/images/icon_17.svg) 54 54, auto;
      .implantCaseBoxSwiper {
        ...
        .implantCaseBox {
          ...
          &-t {
            ...
            overflow: hidden;
            transition: all 0.3s;
            cursor: url(@/assets/yahoo/images/icon_18.svg) 54 54, auto;
            div {
              width: 100%;
            }
            img {
