...
import doctorLists_hk from '~/assets/yahoo/js/doctor'
  ...
  <div>
    ...
    <div class="pageIn whitebgColor">
      ...
      <div class="mobile-orthodontics">
        <YahooServiceIntroduce :introduceData="orthodonticsIntroduceData" />
      </div>
      ...
      <div class="hospital" v-if="windowWidth < 768">
        ...
        <div>政府指定長者醫療券機構</div>
        <div class="care2-btn">
          <YahooPageAnimBtnTypeTwo :str="'立即線上諮詢'" />
        </div>
      </div>
      <div class="pc_hospital" v-else>
        ...
        <div>政府指定長者醫療券機構</div>
        <div class="care2-btn">
          <YahooPageAnimBtnTypeTwo :str="'立即預約牙齒檢查'" />
        </div>
      </div>
      <div class="care">
        ...
        <div class="care-btn" style="display: none">
          <YahooPageAnimBtnTypeTwo :str="'與我們了解更多'" />
        </div>
      </div>
      ...
      <div class="care2-btn">
        <YahooPageAnimBtnTypeTwo :str="'立即WhatsApp預約檢查'" />
      </div>
      ...
      <YahooServiceProcess :processData="processData" v-if="isShowOldNode" />
      ...
      &-l {
        ...
        .image {
          ...
          &::after {
            ...
            background: url(@/assets/yahoo/images/icon_12.png);
