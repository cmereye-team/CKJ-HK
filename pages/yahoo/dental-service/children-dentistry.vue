...
import { whatsAppNum } from '~/assets/yahoo/js/common'
  ...
  <div>
    ...
    <div class="pageIn whitebgColor">
      ...
      <div class="tabNav pageCon">
        <nuxt-link :to="'/yahoo'" title="深圳愛康健口腔醫院" alt="深圳愛康健口腔醫院"
    ...
    <div class="YaNavBox shownav" v-if="shownav_2">
      <img
        class="close"
        src="@/assets/yahoo/images/icon_7.svg"
        alt=""
        @click.stop="shownav_2 = !shownav_2"
      />
      <nuxt-link :to="`/yahoo/dental-service/scaling-and-polishing`" class="YaNav">
        <div class="YaNav-img">
          <img
            class="YaNav-img-in"
            srcset="
...
.YaNav {
  ...
  &-img {
    ...
    &::before {
      ...
      width: 35.16px;
      height: 28.57px;
      background: url(@/assets/yahoo/images/icon_45.svg) no-repeat;
    ...
    &-lists {
      ...
      &-in {
        ...
        &::after {
          ...
          width: 34px;
          height: 20px;
          background: url(@/assets/yahoo/images/icon_46.svg) no-repeat;
          background-size: 100% 100%;
          position: absolute;
          left: 120px;
          bottom: 35px;
