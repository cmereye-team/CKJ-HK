...
import doctorLists_cs from '~/assets/yahoo/js/doctor'
import { toWhatsApp } from '~/assets/yahoo/js/common'
...
const getNewsLists = async (idx = 0) => {
  ...
  let a = [
    ...
    },
    {
      idx: 1,
      id: 15,
      url: '/yahoo/news/news-information/',
    },
    {
      idx: 2,
      id: 16,
      url: '/yahoo/news/news-tooth-wiki/',
    },
  ]
...
const handlevideBoxBtn = () => {
  // router.push('')
  let _arr = ['/yahoo/news/coverage', '/yahoo/news/information', '/yahoo/news/tooth-wiki']
            ...
            <div class="time" v-if="indexNewsCur === 2">
              ...
              >
                <div
                  ...
                  title="分享"
                >
                  <img src="@/assets/yahoo/images/icon_47.svg" alt="" />
                </div>
                <div class="shareIcon-in" v-if="actShowShare === item.id">
                  <div
                    ...
                    title="Facebook 分享"
                  >
                    <img src="@/assets/yahoo/images/icon_49.svg" alt="" /><span
                      >Facebook 分享</span
                    >
                  </div>
                  <div
                    ...
                    title="複製連結"
                  >
                    <img src="@/assets/yahoo/images/icon_48.svg" alt="" /><span
                      >複製連結</span
                    >
                  </div>
                </div>
