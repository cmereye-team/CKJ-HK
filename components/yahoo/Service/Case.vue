...
const caseLists = [
  {
    ...
    jos: '退休人士',
    context:
      '年紀大上顎漸漸甩晒啲牙，食唔到野身體都差咗。我仔帶我去植牙之後，咬到食物之餘講野仲清楚咗。',
  },
  {
    ...
    jos: '中學老師',
    context:
      '因課外活動小意外，其中隻門牙嚴重斷開咗。經同事介紹搵愛康健，翌日就可以安排到植牙，醫生專業及服務效率度高，深圳植牙信心推薦！',
  },
  {
    ...
    jos: '金融界新人',
    context:
      '下排左邊智慧齒橫生好難清潔，智慧齒及旁邊隻大牙嚴重蛀牙。唔想咁後生少隻大牙用，所以就選擇植牙。依加牙齒依然整齊、有力。',
  },
]
</script>
