    ...
    <div :class="`${stepData.pageName}Bg`">
      <div :class="['step-in', 'pageCon', stepData.pageName]">
        <div
          :class="[
            'step-in-box',
            stepData.stepLists.length === 1 ? 'oneBox' : '',
          ]"
          v-for="(step, stepIndex) in stepData.stepLists"
          :key="stepIndex"
        >
          <div class="step-itemLists">
            <div
              :class="[
                'step-itemLists-in',
                {
                  oneBoxListItem: stepData.stepLists.length === 1,
                  listInOneTiem: step.length === 1,
                },
              ]"
            ...
            >
              ...
              <span class="text">
                <div class="text-th" v-if="stepChild.textTh">
                  {{ stepChild.textTh }}
                </div>
          ...
          <div
            class="step-bottom"
            v-if="stepIndex === 1 && stepData.isShowBottom"
          >
            {{ stepData.bottomText }}
          </div>
        </div>
