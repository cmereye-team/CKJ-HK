...
import { smallPhoneNum, phoneNum } from '~/assets/yahoo/js/common'
...
const navLists = [
  ...
  },
  {
    ...
    link: `/yahoo/brand/${appState.brand}`,
  },
  {
    name: 'components.footer.nav_dental_service',
    link: `/yahoo/dental-service/implant`,
  },
  {
      ...
      <div class="footer-content bigPageCon">
        ...
        <div class="footer-content-logo_one">
          <nuxt-link
            ...
            alt="深圳愛康健口腔醫院"
          >
            <img src="@/assets/yahoo/images/footerLogo.svg" alt="logo" />
          </nuxt-link>
        </div>
        <div class="footer-content-text">
          ...
          <nuxt-link :to="`tel: ${phoneNum}`" class="footer-content-text-tel">
            <img src="@/assets/yahoo/images/navIcon_1.png" alt="" />
        ...
        <div class="footer-content-icon">
          <div class="footer-content-icon-in">
            ...
            >
              <img
                src="@/assets/yahoo/images/icon_1.png"
                alt="facebook"
                title="facebook"
              />
            </nuxt-link>
          ...
          <div class="footer-content-icon-in">
            <nuxt-link to="https://www.instagram.com/ckj_hk/" target="_blank">
              <img
                src="@/assets/yahoo/images/icon_2.png"
                alt="instagram"
                title="instagram"
              />
            </nuxt-link>
          ...
          <div class="footer-content-icon-in">
            ...
            >
              <img
                src="@/assets/yahoo/images/icon_3.png"
                alt="youtube"
                title="youtube"
              />
            </nuxt-link>
          ...
          <div class="footer-content-icon-in">
            <div class="weChat">
              <img src="@/assets/yahoo/images/navIcon_3.png" alt="weChat" />
              <div class="navbarBox">
        ...
        <div class="footer-content-Disclaimer">
          <nuxt-link to="/yahoo/privacyPolicy">{{
            $t('components.footer.privacy_policy')
          }}</nuxt-link>
          &
          <nuxt-link to="/yahoo/disclaimer">{{
