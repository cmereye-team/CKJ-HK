    ...
    <div class="menuBar-in bgColor">
      <div class="menuBar-in-l">
        <div class="menuBar-box" title="深圳市醫保定點醫院">
          <img src="@/assets/yahoo/images/icon_38.svg" alt="" />
          <p>深圳市醫保定點醫院</p>
        </div>
        <div class="menuBar-box" title="深圳二級口腔醫院">
          <img src="@/assets/yahoo/images/icon_39.svg" alt="" />
          <p>深圳二級口腔醫院</p>
        </div>
      </div>
      <div class="menuBar-in-r">
        <nuxtLink :to="`tel: ${phoneNum}`" class="menuBar-box" title="香港熱線">
          <img src="@/assets/yahoo/images/navIcon_1.png" alt="香港熱線" />
        ...
        <div class="menuBar-icon">
          ...
          <div class="menuBar-icon-in weChatBox">
            <img
              src="@/assets/yahoo/images/navIcon_3.png"
              alt="weChat"
              title="weChat"
            />
