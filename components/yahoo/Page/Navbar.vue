...
import { smallPhoneNum, whatsapplink } from '~/assets/yahool/js/common'
  ...
  >
    ...
    >
      <div class="iconDialogBox" v-if="showDialogBox">
        ...
        <img
          ...
          data-ord="1"
          src="@/assets/yahool/images/icon_42.svg"
          alt=""
        />
        <img
          class="iconDialogBox-icon"
          data-ord="2"
          src="@/assets/yahool/images/icon_43.svg"
          alt=""
        />
        <img
          class="iconDialogBox-icon"
          data-ord="3"
          src="@/assets/yahool/images/icon_44.svg"
          alt=""
        />
      </div>
      ...
      <div class="navbar-content-whatApp-btn">
        ...
        <div class="navbar-content-whatApp-btn-img">
          <div class="navbar-content-whatApp-btn-img-in">
            <img src="@/assets/yahool/images/navIcon_2.png" alt="" />
          </div>
        </div>
    ...
    <div class="navbar-content-in pageTop" @click="toPageTop">
      <img
        srcset="
          ...
          @/assets/yahool/images/navIcon_4.png
        "
        src="@/assets/yahool/images/navIcon_4.png"
        alt="toTop"
      />
    </div>
    <div class="navbar-content-mb">
      <nuxt-link
        ...
        :to="whatsapplink"
      >
        <img src="@/assets/yahool/images/icon_65.svg" alt="" />
        <span>WhatsApp</span>
      </nuxt-link>
      <nuxt-link
        class="navbar-content-mb-in"
      ...
      >
        <img src="@/assets/yahool/images/icon_64.svg" alt="" />
      ...
      >
        <img
          ...
          src="@/assets/yahool/images/icon_66.svg"
          alt=""
        />
    ...
    >
      ...
      <div class="navForm-icon" @click="navFormClose">
        <img src="@/assets/yahool/images/icon_7.svg" alt="close" />
      </div>
    </div>
...
.navbar-content {
  ...
  #navPcTel {
    background-image: url(@/assets/yahool/images/navIcon_1.png);
    background-repeat: no-repeat;
    background-position: 43% 57%;
  }
  #navPcWeChat {
    background-image: url(@/assets/yahool/images/navIcon_3.png);
    background-repeat: no-repeat;
    background-position: 50%;
  }
  // #navPcWhatsapp{
  //   background-image:url(@/assets/yahool/images/navIcon_2.png);
  //   background-repeat: no-repeat;
  //   background-position: 50%;
  // }
  #navPcFaceBook {
    background-image: url(@/assets/yahool/images/navIcon_6.png);
  }
  #navPcContactForm {
    background-image: url(@/assets/yahool/images/navIcon_5.png);
    background-repeat: no-repeat;
    background-position: 50%;
  }
  &-mb {
