...
import { phoneNum } from '~/assets/yahool/js/common'
...
const getWindowResize = () => {
  if (window.innerWidth > 768) mapConShow.value = true
  else mapConShow.value = false
}
  ...
  [
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/09/11e84702229e6caf.jpg',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/faf033fd50b18824.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/b741f54f1b105876.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/fe00a2ba47a161b5.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/5f6257f23815c0b8.png',
  ...
  [
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/63dbe40ee13b53e9.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/f75bb70e48d1a50e.png',
  ...
  [
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/4783ff2e8f17beff.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/d6c09b604319be78.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/47efa458657fb4a5.png',
  ...
  [
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/009aa648694461bb.png',
  ...
  [
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/547f7fa32b8a7154.png',
    ...
    },
    {
      ...
      addressUrl:
        'https://static.cmereye.com/imgs/2023/05/2d4f2be9d307d63a.png',
      googleMap:
        'https://goo.gl/maps/VKT1orRbiS8mAiN39?coh=178572&entry=tt門診門',
...
<template>
  <div class="index-contactUs">
    <div class="index-contactUs-t pageCon">
      ...
      <div>
        <YahooAreaTab :isAdPage="isAdPage" />
      </div>
    </div>
    <div class="address">
      <div
        class="address-in"
        :class="{ firstBox: addressItem.id === '101' }"
        v-for="(addressItem, addressIndex) in allAddressLists[
      ...
      >
        ...
        <div class="address-box">
          ...
          <div class="content">
            <span
              >{{ $t('contactUs.hospital_address') }}：{{
                $t(addressItem.address)
              }}</span
            >
            <span
              >{{ $t('contactUs.hours_of_Operation') }}：{{
                $t(addressItem.time)
              }}</span
            >
            <span
              >{{ $t('contactUs.check_the_phone') }}：{{
                addressItem.phone
              }}</span
            >
          </div>
          <span
            class="showIcon"
            :class="{ cc: currentAddress === addressItem.id }"
            @click="handleAddress(addressItem.id)"
