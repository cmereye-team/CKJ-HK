  ...
  <div class="dropdown">
    <div class="dropdown-in">
      ...
      <div class="dropdown-in-itemBox" v-show="dropdownCategory">
        <ul>
          <li
            v-for="(categoryItem, categoryIndex) in dropdownCategoryLists"
            :key="categoryIndex"
            @click="handleDropdownCategory($t(categoryItem.name))"
          >
            {{ $t(categoryItem.name) }}
          </li>
        </ul>
    ...
    <div class="dropdown-in">
      <div
        class="dropdown-in-content"
        id="month"
        @click="dropdownMonth = !dropdownMonth"
      >
      ...
      <div class="dropdown-in-itemBox" v-show="dropdownMonth">
        <ul>
          <li
            v-for="(monthItem, monthIndex) in dropdownMonthLists"
            :key="monthIndex"
            @click="handleDropdownMonth(monthItem)"
          >
            {{ monthItem.name }}
          </li>
        </ul>
