...
<template>
  <div class="index-aboutUs">
    ...
    <div class="index-aboutUs-swiper bigPageCon">
      ...
      >
        <SwiperSlide
          class="index-aboutUs-swiper-in-slide"
          v-for="(item, index) in imgsLists"
          :key="index"
        >
          <el-image
            loading="lazy"
            :src="item"
            alt="深圳愛康健口腔醫院_醫院相片"
            title="深圳愛康健口腔醫院_醫院相片"
            @click="handleshowdeBox(index)"
          />
        </SwiperSlide>
      </Swiper>
      <div
        class="index-aboutUs-swiper-in-mouseLeft"
        @mouseleave.stop="changemouse('leave')"
        @mouseover.stop="changemouse('over')"
      ></div>
      <div
        class="index-aboutUs-swiper-in-mouseRight"
        @mouseleave.stop="changemouse('leave')"
        @mouseover.stop="changemouse('over')"
      ></div>
    </div>
    <div class="index-aboutUs-mbswiper">
      <swiper
        class="index-aboutUs-mbswiper-t"
        :modules="[Controller]"
      ...
      <swiper
        class="index-aboutUs-mbswiper-b"
        :modules="[Controller]"
      ...
      >
        <SwiperSlide
          class="index-aboutUs-mbswiper-b-slide"
          v-for="(item, bindex) in imgsLists"
          :key="bindex"
        >
          <el-image
            loading="lazy"
    ...
    <div class="index-aboutUs-content smallPageCon">
      <div class="contentBox">
        <h2>科技護航，安全放心</h2>
        <span
          >優質的診療服務，在於醫生的專業素養，以及匹配的醫療設備的先進程度。愛康健從口腔檢查到臨床手術，全程採購主流牙科設備，與時俱進開展醫生職業技能培訓。我們信奉技術，加進口設備，才能有好的診療功效。</span
        >
      </div>
      <div class="contentBox">
        <h2>嚴謹治療，為效果護航</h2>
        <span
          >嚴格執行符合世界牙科聯盟(FDI)的診療標準，消毒隔離系統達到8個「一」無菌診療模式：一人一診室，一醫一助，一機一用，一次一消毒，消毒更全面。</span
        >
      </div>
    </div>
    <div class="deBox" v-show="showdeBox" @click.stop="showdeBox = false">
      <div class="deBox-close" @click="showdeBox = false">
        ...
        >
          ...
          <path
            d="M28 31L50.6154 51.4878L28 73"
            stroke="#FC1682"
          ...
          />
          <path
            d="M73.6172 31L51.0018 51.4878L73.6172 73"
            stroke="#FC1682"
            stroke-width="9.69231"
            stroke-linecap="round"
            stroke-linejoin="round"
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_2664_13034"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_2664_13034"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div class="deBox-in">
        <swiper class="deBox-in-swiper" @swiper="setdeBoxSwiperRef">
          <SwiperSlide
            class="deBox-in-swiper-slide"
            v-for="(item, deBoxindex) in imgsLists"
            :key="deBoxindex"
          >
            <el-image
              loading="lazy"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_2664_13039"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_2664_13039"
                  result="shape"
                />
              </filter>
            </defs>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_2664_13030"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_2664_13030"
                  result="shape"
                />
              </filter>
            </defs>
...
.index-aboutUs {
  ...
  &-content {
    ...
    .contentBox {
      ...
      &:first-child::after {
        ...
        width: 36px;
        height: 100%;
        background: url(https://static.cmereye.com/imgs/2024/02/92c4f6042aafba5d.png)
          no-repeat;
  ...
  .deBox {
    ...
    background: rgba(254, 230, 241, 0.5);
    &-close {
      width: 99px;
      height: 99px;
      position: absolute;
    ...
    &-swiper {
      ...
      &-in {
        ...
        &-slide {
          .el-image {
            &:hover {
              box-shadow: 0 0.2604vw 0.5208vw rgba(0, 0, 0, 0.3);
            }
          }
        }
      }
          ...
          &.swiper-slide-active {
            .el-image {
              ...
              &::before {
                ...
                border-color: transparent transparent var(--indexColor1)
                  transparent;
                position: absolute;
                top: -20px;
                left: 50%;
